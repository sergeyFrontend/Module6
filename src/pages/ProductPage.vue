          ...
          >
            ...
            <fieldset class="form__block">
              ...
              <ul class="colors">
                <li
                  class="colors__item"
                  v-for="ColorPage of product.colors"
                  :key="ColorPage.id"
                >
                  <label class="colors__label">
                    ...
                    <span
                      class="colors__value"
                      :style="{ backgroundColor: ColorPage.code }"
                    >
                    </span>
                  </label>
                </li>
            ...
            <div class="item__row">
              <ProductInBasket  :count.sync="productAmout"/>
      ...
      <div class="item__desc">
        ...
        <div class="item__content">
          ...
          <p>
            ...
            маршруты и планировать новые вело прогулки.
          </p>
          <h3>Дизайн</h3>
          <p>
            ...
            защиты от влаги IPX 7 . Это означает , что устройство не боится пыли
            , а также выдерживает кратковременное (до 30 минут) погружение в
            воду на глубину не более 1метра.
          </p>
        </div>
      </div>
    </section>
